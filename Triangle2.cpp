...
Triangle2::Triangle2(GLfloat VAO, GLfloat VBO, GLfloat colorVBO)
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(colorBufferData2), colorBufferData2, GL_STATIC_DRAW);
}
